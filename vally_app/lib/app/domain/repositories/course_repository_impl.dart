...
class CourseRepositoryImpl implements CourseRepository {
  void _initializeData() {
    if (!_isInitialized) {
      ...
      _enrolledCourses.addAll(_allCourses.where(
  ...
  Future<bool> joinCourseWithCode(String invitationCode) async {
    ...
    if (!targetCourse.enrolledStudents.contains(_currentStudentName)) {
      ...
      final updatedCourse = Course(
        ...
        enrolledStudents: [...targetCourse.enrolledStudents, _currentStudentName],
      ...
      if (!_enrolledCourses.any((c) => c.id == targetCourse.id)) {
        ...
        final enrolledIndex = _enrolledCourses.indexWhere((c) => c.id == targetCourse.id);
        if (enrolledIndex != -1) {
  ...
  Future<Course> updateInvitationCode(String courseId) async {
    ...
    final courseIndex = _allCourses.indexWhere((course) => course.id == courseId);
